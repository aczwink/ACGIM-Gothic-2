...
INSTANCE ItPo_PotionOfDeath_01_Mis(C_Item)
{
	...
	FUNC VOID UseItPo_PotionOfDeath()
	{
		IF (hero.guild == GIL_KDF)
		{
			...
			PrintScreen	(PRINT_LearnSTR5, -1, 35, FONT_SCREEN, 5);
			PrintScreen	(PRINT_LearnDex5, -1, 45, FONT_SCREEN, 5);
			PrintScreen (PRINT_FullyHealed, - 1, 55, FONT_Screen, 5);
			PrintScreen("Deine Wunden schließen", - 1, 65, FONT_Screen, 5);
			PrintScreen("sich in Zukunft von selbst", - 1, 70, FONT_Screen, 5);
