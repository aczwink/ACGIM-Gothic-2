...
func void DIA_Addon_Pedro_Statuette_Info ()
{
	...
	if (other.guild == GIL_NONE)
	{
		...
		AI_Output (self, other, "DIA_Addon_Pedro_Statuette_09_02_AC"); //Unter diesen wahrlich besonderen Umständen verlangen wir keine 1000 Goldstücke.

		Log_CreateTopic (TOPIC_Addon_RangerHelpKDF, LOG_MISSION);
		Log_SetTopicStatus(TOPIC_Addon_RangerHelpKDF, LOG_RUNNING);
		B_LogEntry (TOPIC_Addon_RangerHelpKDF,"Pedro, der Novize, erlässt mir die 100 Goldstücke gegen die vermisste Statuette. Ich sollte sie jemandem im Kloster übergeben."); 
	}
	else
	{
		AI_Output (self, other, "DIA_Addon_Pedro_Statuette_09_03"); //Ich fürchte, auch mit diesem kostbaren Kleinod kann ich dich nicht einlassen.
...
func void DIA_Pedro_AUFNAHME_Info ()
{
	...
	*/
	...
	&& ((Npc_HasItems (hero, ItMi_Gold) >= Summe_Kloster) || (Npc_KnowsInfo (other, DIA_Addon_Pedro_Statuette) && Npc_HasItems (other,ItMi_LostInnosStatue_Daron)))
...
FUNC VOID DIA_Pedro_AUFNAHME_YES()
{
	...
	//ADDON>
 	if (Npc_KnowsInfo (other, DIA_Addon_Pedro_Statuette) && Npc_HasItems (other,ItMi_LostInnosStatue_Daron))
 	{
