...
func void DIA_Mil_310_Stadtwache_FirstWarn_Info()
{
	...
	else // ------ normales Reinkommen ------
	{
		...
		// ------ ohne Rüstung ------
		if((Npc_HasEquippedArmor(other) == FALSE) || (Hlp_IsItem(itm, Item_Armor_DemolishedCloth) == TRUE)) //standard amor => no armor
		&& (hero.guild == GIL_NONE) 
		{
...
FUNC VOID DIA_Mil_310_Stadtwache_Passierschein_Info()
{
	...
	if((Npc_HasEquippedArmor(other) == FALSE) || (Hlp_IsItem(itm, Item_Armor_DemolishedCloth) == TRUE)) //ohne Rüstung //standard amor => no armor
	{
