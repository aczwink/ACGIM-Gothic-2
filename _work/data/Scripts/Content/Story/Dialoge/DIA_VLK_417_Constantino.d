...
func void DIA_Constantino_MushroomsRunning_Sell()
{
	...
	nMushrooms02 = Npc_HasItems(other, ItPl_Mushroom_02);
	...
	if (nMushrooms01 > 0)
	{
		...
		Constantino_DunkelpilzCounter = Constantino_DunkelpilzCounter + nMushrooms01;
				
		B_GiveInvItems (self, other, itmi_gold, (nMushrooms01 * Value_Mushroom_02) );
		B_GiveInvItems (other, self, ItPl_Mushroom_01, nMushrooms01);
		
		Npc_RemoveInvItems(self, ItPl_Mushroom_01, nMushrooms01); //remove the mushrooms so that they can't be bought back
	};
	...
	if (nMushrooms02 > 0)
	{
		...
		B_GiveInvItems (self, other, itmi_gold, (nMushrooms02 * Value_Mushroom_01) );
		B_GiveInvItems (other, self, ItPl_Mushroom_02, nMushrooms02);
		
		Npc_RemoveInvItems(self, ItPl_Mushroom_02, nMushrooms02); //remove the mushrooms so that they can't be bought back
	};
...
func void DIA_Constantino_MushroomsRunning_Why()
{
	...
	else if (Constantino_DunkelpilzCounter >= 50)
	{
		...
		//Try to hint to "Blaupilztrank"
		AI_Output(self, other, "DIA_CONSTANTINO_SJCGIMCUT_01"); //ja und...
		AI_Output(self, other, "DIA_CONSTANTINO_SJCGIMCUT_02"); //Ich denke ich kann dir einige Rezepturen verraten
		AI_Output(self, other, "DIA_CONSTANTINO_SJCGIMCUT_03"); //Ein seltenes Gebräu was ich dir beibringen kann...
...
FUNC VOID DIA_Constantino_TEACH_Info()
{
	...
	&& (PLAYER_TALENT_ALCHEMY[POTION_MushroomMana] == TRUE)
	{
	...
	if(Player_KnowsDunkelpilzBonus == TRUE && PLAYER_TALENT_ALCHEMY[POTION_MushroomMana] == FALSE)
	{
		Info_AddChoice (DIA_Constantino_TEACH, B_BuildLearnString ("Blaupilztrank", B_GetLearnCostTalent (other, NPC_TALENT_ALCHEMY, POTION_MushroomMana)), DIA_Constantino_Teach_MushRoomManaPotion);
	};
};
...
func void DIA_Constantino_Teach_MushRoomManaPotion()
{
	B_TeachPlayerTalentAlchemy(self, other, POTION_MushroomMana);
	Info_ClearChoices (DIA_Constantino_Teach);
};